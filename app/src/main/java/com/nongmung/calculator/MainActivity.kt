package com.nongmung.calculator
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvErase.setOnClickListener{appendOnExpresstion("-",false)}
        tvMultiply.setOnClickListener{appendOnExpresstion("*",false)}
        tvDivision.setOnClickListener { appendOnExpresstion("/",false) }
        tvPelenLeft.setOnClickListener{appendOnExpresstion("(",false)}
        tvPelenRight.setOnClickListener{appendOnExpresstion(")",false)}
